            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MSN_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MSN_TITLE = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    MSN_ISACTIVATED = table.Column<bool>(type: "bit", nullable: false),
                    MSN_REGISTERTIME = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MSN_ALTTIME = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
